...
last_x_AT = (system("tail -1 '../data/int/country-AT.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_AT = (system("tail -1 '../data/int/country-AT.tsv' | cut -f17") + 0)

last_x_BE = (system("tail -1 '../data/int/country-BE.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_BE = (system("tail -1 '../data/int/country-BE.tsv' | cut -f17") + 0)

last_x_CA = (system("tail -1 '../data/int/country-CA.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_CA = (system("tail -1 '../data/int/country-CA.tsv' | cut -f17") + 0)

last_x_FR = (system("tail -1 '../data/int/country-FR.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_FR = (system("tail -1 '../data/int/country-FR.tsv' | cut -f17") + 0)

last_x_DE = (system("tail -1 '../data/int/country-DE.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_DE = (system("tail -1 '../data/int/country-DE.tsv' | cut -f17") + 0)

last_x_HU = (system("tail -1 '../data/int/country-HU.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_HU = (system("tail -1 '../data/int/country-HU.tsv' | cut -f17") + 0)

last_x_IR = (system("tail -1 '../data/int/country-IR.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_IR = (system("tail -1 '../data/int/country-IR.tsv' | cut -f17") + 0)

last_x_IT = (system("tail -1 '../data/int/country-IT.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_IT = (system("tail -1 '../data/int/country-IT.tsv' | cut -f17") + 0)

last_x_JP = (system("tail -1 '../data/int/country-JP.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_JP = (system("tail -1 '../data/int/country-JP.tsv' | cut -f17") + 0)

last_x_KR = (system("tail -1 '../data/int/country-KR.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_KR = (system("tail -1 '../data/int/country-KR.tsv' | cut -f17") + 0)

last_x_NL = (system("tail -1 '../data/int/country-NL.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_NL = (system("tail -1 '../data/int/country-NL.tsv' | cut -f17") + 0)

last_x_PT = (system("tail -1 '../data/int/country-PT.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_PT = (system("tail -1 '../data/int/country-PT.tsv' | cut -f17") + 0)

last_x_ES = (system("tail -1 '../data/int/country-ES.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_ES = (system("tail -1 '../data/int/country-ES.tsv' | cut -f17") + 0)

last_x_CH = (system("tail -1 '../data/int/country-CH.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_CH = (system("tail -1 '../data/int/country-CH.tsv' | cut -f17") + 0)

last_x_UK = (system("tail -1 '../data/int/country-GB.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_UK = (system("tail -1 '../data/int/country-GB.tsv' | cut -f17") + 0)

last_x_US = (system("tail -1 '../data/int/country-US.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_US = (system("tail -1 '../data/int/country-US.tsv' | cut -f17") + 0)

last_x_SE = (system("tail -1 '../data/int/country-SE.tsv' | cut -f2") + 0)
...
last_y_last_week_pm_SE = (system("tail -1 '../data/int/country-SE.tsv' | cut -f17") + 0)
